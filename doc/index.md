...
Use this directory for detailed `mvp-dataset` usage and API notes.

## Pages

- [Overview](overview.md): project model and core concepts.
- [Dataset API](dataset-api.md): `Dataset` construction, stages, iteration, and state APIs.
- [Source Formats](source-formats.md): tar, JSONL, Parquet, and Lance source arguments.
